...
activities = {
    ...
    "Swimming Club": {
        "description": "Improving swim techniques and conditioning in the pool",
        "schedule": "Wednesdays and Fridays, 3:00 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["luna@mergington.edu", "nicolas@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Explore painting, drawing, and mixed media projects",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["sofia@mergington.edu", "mateo@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, staging, and performance for school plays",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["amelia@mergington.edu", "david@mergington.edu"]
    },
    "Math Olympiad": {
